                ...
                <Container fluid='lg' className='header__container'>
                    <div className="header__content">
                        ...
                        <nav className='header__nav nav-header'>
                                <Link to='/' className="nav-header__item">Home</Link>
                                <Link to='/shop' className="nav-header__item">Shop</Link>
                                <Link to='/brand' className="nav-header__item">About the brand</Link>
                                <Link to='/contact' className="nav-header__item">Contacts</Link>
                        </nav>
                        <div className='header__tel info-header'> 
                            <img src="/img/header/call.svg" alt="call" />
                            <div className='info-header__tel'> +38 (096) 899-17-31</div>
                        </div>
